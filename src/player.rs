...
impl Default for DirectionAnimations {
    fn default() -> Self {
        let anim_duration = Duration::new(ANIMATION_DURATION, 0);
         DirectionAnimations { 
            up: Animation::from_indices(9..=11, FrameRate::from_total_duration(anim_duration)), 
            down: Animation::from_indices(0..=2, FrameRate::from_total_duration(anim_duration)), 
            left: Animation::from_indices(3..=5, FrameRate::from_total_duration(anim_duration)), 
            right: Animation::from_indices(6..=8, FrameRate::from_total_duration(anim_duration)),
        }
    }
}
